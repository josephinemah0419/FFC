export const zh = {
  ...
  menu: {
    hero: { eyebrow: "FFC 餐厅", title: "我们的菜单", copy: "探索 FFC 的餐点、茶饮、特色饮品、甜点与酱料。" },
    groups: ["餐点", "饮品"],
    categories: ["饭类", "主食汤", "西式鸡扒", "小吃", "甜点", "FFC 酱料", "特调饮料", "普洱 黑茶", "白茶", "乌龙 青茶", "红茶", "宇治抹茶", "冷茶拿铁", "纯冷抹茶", "特色饮品", "其他"],
    items: [
      ["黄姜叁巴饭", ""],
      ["蜜汁鸡扒盖饭", ""],
      ["炸鸡扒盖饭", ""],
      ...
      ["坚果巧克力棒", ""],
      ["天然水果雪糕", "口味视当天而定"],
      ["凤凰酱 220g", "Rasa Bunga Kantan"],
      ["抹茶蒜米酱 220g", ""],
      ["叁巴辣椒茶酱 220g", ""],
      ["帝王酱 220g", ""],
      ["万能酱 220g", ""],
      ["虾米啰吔酱 250g", ""],
      ["魔鬼辣椒叁巴茶酱 170g", "可用于烹调或直接食用 不含猪肉。"],
      ["魔鬼辣椒啰亚酱 250g", ""],
      ["魔鬼辣椒粉 20g", ""],
      ["烘干魔鬼辣椒粉 10g", ""],
      ["蒜米魔鬼辣椒酱 200g", ""],
      ...
      ["红色混蛋（汽水）", "苏打 白茶 樱桃番茄"],
      ["红色混蛋（酒）", "清酒 白茶 樱桃番茄"],
      ["跌倒很痛（汽水）", "苏打 熟普洱茶 带木质调"],
      ["跌倒很痛（酒）", "清酒 潮州茶 水果甜味"],
      ["古弦", "清酒 白茶与六堡茶点缀"],
      ["石青山", "蔬菜 豆腐与清酒的鲜味 加抹茶点缀"],
      ["红鹭", "红茶 清酒与苏打点缀"],
      ["乡情", "橙子与百香果风味 加桃子抹茶点缀"],
      ["矿泉水 500ml", ""],
    ],
