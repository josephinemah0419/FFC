...
export default function CertificationPage() {
  ...
  return <main>
    <section className="certification-hero"><div className="shell certification-hero-grid">
      ...
      <Reveal className="certification-hero-visual" delay={.12}><Image src="/ffc-certification-characters.png" alt={t.alt.certificate} width={1536} height={1024} priority sizes="(max-width: 680px) 100vw, (max-width: 900px) 90vw, (max-width: 1200px) 52vw, 760px" /></Reveal>
    </div></section>
